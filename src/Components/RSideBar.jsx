        ...
        <div className="relative z-10 w-[50%] h-[85%] ">
          {chat ? (
            <div className="relative group right-0 cursor-pointer">
              ...
              >
                <i class="fa-solid fa-xmark text-3xl text-amber-400"></i>
              </span>
              <div
          ...
          <div className="w-[100%] h-[100%] rounded-2xl  flex flex-col text-white border-1 p-4 border-[rgba(79,209,199,0.3)]">
                ...
                <div className="mt-2 ">
                  {hints.map((item) => {
                    return (
                      <div
                        key={item.id}
                        className="p-4 mb-2 bg-[rgba(63,22,65,0.3)] rounded-xl border-[1px] drop-shadow-xl shadow-2xs border-[rgb(193,65,200)]"
                      >
